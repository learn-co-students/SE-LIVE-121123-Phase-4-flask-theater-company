...
from models import CastMember, Production, Actor, db
...
with app.app_context():
    ...
    hamlet_crew_members = [
        CastMember(actor=actors.pop(), role=role, production_id=p1.id)
    ...
    cats_crew_members = [
        CastMember(actor=actors.pop(), role=role, production_id=p2.id)
    ...
    carmen_crew_members = [
        CastMember(actor=actors.pop(), role=role, production_id=p3.id)
    ...
    hamilton_crew_members = [
        CastMember(actor=actors.pop(), role=role, production_id=p4.id)
