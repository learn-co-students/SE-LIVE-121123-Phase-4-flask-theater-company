...
### Configure Application 
  ...
  * 3.4 Create a .gitignore file and add the .env file to it
...
### Commit your app to GitHub
 ...
 11. ✅ run `git init` in the local repo for your app.  
   * 11.1 Set your local repo to push to your Github repo `git add remote origin <github repo url>`
...
### Create a new web service on Render
  ...
  * 12.3. Click advanced and Add 3 Environment Variables 
